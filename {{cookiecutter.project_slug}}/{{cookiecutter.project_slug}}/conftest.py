...
from {{cookiecutter.project_slug}}.services.redis.dependency import get_redis_pool
{%- endif %}
{%- if cookiecutter.enable_rmq == "True" %}
from aio_pika import Channel
from aio_pika.abc import AbstractExchange, AbstractQueue
from aio_pika.pool import Pool
from {{cookiecutter.project_slug}}.services.rabbit.dependencies import get_rmq_channel_pool
from {{cookiecutter.project_slug}}.services.rabbit.lifetime import init_rabbit, shutdown_rabbit

{%- endif %}
{%- if cookiecutter.enable_kafka == "True" %}
from aiokafka import AIOKafkaProducer
from {{cookiecutter.project_slug}}.services.kafka.dependencies import get_kafka_producer
from {{cookiecutter.project_slug}}.services.kafka.lifetime import init_kafka, shutdown_kafka
{%- endif %}

from {{cookiecutter.project_slug}}.settings import settings
from {{cookiecutter.project_slug}}.web.application import get_app


{%- if cookiecutter.orm == "sqlalchemy" %}
from sqlalchemy.ext.asyncio import create_async_engine, AsyncSession, AsyncEngine, AsyncConnection, async_sessionmaker
from {{cookiecutter.project_slug}}.db.dependencies import get_db_session
from {{cookiecutter.project_slug}}.db.utils import create_database, drop_database
{%- elif cookiecutter.orm == "tortoise" %}
from tortoise.contrib.test import finalizer, initializer
from tortoise import Tortoise
from {{cookiecutter.project_slug}}.db.config import MODELS_MODULES, TORTOISE_CONFIG
import nest_asyncio

nest_asyncio.apply()
{%- elif cookiecutter.orm == "ormar" %}
from sqlalchemy.engine import create_engine
from {{cookiecutter.project_slug}}.db.config import database
from {{cookiecutter.project_slug}}.db.utils import create_database, drop_database
{%- elif cookiecutter.orm == "psycopg" %}
from psycopg import AsyncConnection
from psycopg_pool import AsyncConnectionPool

from {{cookiecutter.project_slug}}.db.dependencies import get_db_pool
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from {{cookiecutter.project_slug}}.db.meta import meta  # noqa: WPS433
    from {{cookiecutter.project_slug}}.db.models import load_all_models  # noqa: WPS433
