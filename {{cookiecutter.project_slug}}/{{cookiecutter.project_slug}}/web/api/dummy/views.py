...
from {{cookiecutter.project_slug}}.db.dao.dummy_dao import DummyDAO
from {{cookiecutter.project_slug}}.db.models.dummy_model import DummyModel
from {{cookiecutter.project_slug}}.web.api.dummy.schema import DummyModelDTO, DummyModelInputDTO
