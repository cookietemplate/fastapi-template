...
from {{cookiecutter.project_slug}}.services.redis.lifetime import init_redis, shutdown_redis
{%- endif %}
...
from {{cookiecutter.project_slug}}.db.models import load_all_models
{%- endif %}
{%- endif %}
