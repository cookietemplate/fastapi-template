...
class Settings(BaseSettings):
    ...
    db_user: str = "{{cookiecutter.project_slug}}"
    db_pass: str = "{{cookiecutter.project_slug}}"
    db_base: str = "{{cookiecutter.project_slug}}"
    {%- endif %}
    db_echo: bool = False
    ...
    # Variables for Redis
    redis_host: str = "{{cookiecutter.project_slug}}-redis"
    redis_port: int = 6379
    ...
    rabbit_host: str = "{{cookiecutter.project_slug}}-rmq"
    ...
    kafka_bootstrap_servers: list[str] = ["{{cookiecutter.project_slug}}-kafka:9092"]
